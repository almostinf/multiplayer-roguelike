...
use super::{CombatStats, Player, Renderable, Name, Position, Viewshed, Monster, BlocksTile, Rect, Item, ProvidesHealing, Consumable, Ranged, InflictDamage, Confusion};
...
pub fn spawn_room(ecs: &mut World, room: &Rect) {
    ...
    {
        let mut rng = ecs.write_resource::<RandomNumberGenerator>();
        let mut num_monsters = rng.roll_dice(1, MAX_MONSTERS + 2) - 3;
